...
namespace Rover.Repository.Migrations
{
    ...
    [Migration("20240523010027_DeletedTrips")]
    partial class DeletedTrips
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rover.Core.Entities.Deleted_Trips", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rover.Core.Entities.Deleted_Trips", b =>
                {
                    b.HasOne("Rover.Core.Entities.Trip", "Trip")
                        .WithMany("DeletedTrips")
                        .HasForeignKey("TripId");

                    b.HasOne("Rover.Core.Entities.User", "User")
                        .WithMany("DeletedTrips")
